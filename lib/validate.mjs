...
export function validateReport(report) {
  ...
  // Timestamp format (basic ISO 8601 check)
  ...
  // Capability must have model_id and provider
  ...
  // Compatibility must have compatible boolean
  ...
  if (report.results && typeof report.results === 'object') {
    ...
    // Validate samples array if present
